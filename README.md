...
| [ModelOptimizationTechniques.ipynb](2%20-%20Keras%20examples/Deep%20Learning/Keras%20Techniques/ModelOptimizationTechniques.ipynb) | Model optimization and performance enhancement strategies | ![Model Optimization](2%20-%20Keras%20examples/Deep%20Learning/Keras%20Techniques/ReadMeImages/Optimization.png) |
...
| [RAGDemoSystem.ipynb](1%20-%20Generative%20AI%20and%20LLM%20examples/Retrieval%20Augmented%20Generation/RAGDemoSystem.ipynb) | Retrieval-Augmented Generation (RAG) system for document Q&A using FAISS vector search, DPR encoders (Hugging Face Transformers), LangChain for PDF processing, and Claude API for answer generation | ![RAG Demo](1%20-%20Generative%20AI%20and%20LLM%20examples/ReadmeImages/RAGImageReadme.png) |
...
| [Codal Gemini Coding Agent](6-%20Agent%20Examples/CodingAgent) | Python native coding agent app that runs in the terminal. | ![CodingAgent](6-%20Agent%20Examples/CodingAgent/assets/images/CodingAgent.png) |
